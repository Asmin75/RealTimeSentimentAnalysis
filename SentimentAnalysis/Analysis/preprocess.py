...
def create_word_features(words):
    ...
    pos_txt = get_tokenized_file('/home/asmin/work/Colz/RealTimeSentimentAnalysis/SentimentAnalysis/Analysis/positive-words.txt')
    neg_txt = get_tokenized_file('/home/asmin/work/Colz/RealTimeSentimentAnalysis/SentimentAnalysis/Analysis/negative-words.txt')
